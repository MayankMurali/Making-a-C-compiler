...
{
       0,    98,    98,    99,   100,   104,   108,   112,   113,   114,
     119,   123,   124,   128,   132,   133,   134,   138,   139,   140,
     141,   142,   147,   147,   147,   147,   151,   152,   156,   156,
     156,   163,   174,   186,   197,   208,   219,   230,   241,   242,
     243,   244,   245,   246,   250,   255,   256,   257,   271,   283,
     296,   309,   322
};
#endif
...
static const yytype_int8 yypact[] =
{
     -22,   -23,   -23,     2,   -23,   -14,   -23,   -23,    15,   -22,
      ...
      44,    40,    45,    33,    28,   -23,    48,   -23,   -23,   -23,
      55,    61,   -23,    40,    40,   -23,   -23,    -9,    40,    24,
      52,   -23,   -23,   -23,   -23,    60,    -9,    49,    40,    40,
      40,    40,    60,    37,    -9,   -23,    24,    40,    40,    40,
      40,    40,    40,    67,   -23,    -3,    -3,   -23,   -23,    70,
      62,    -9,   -23,    -9,    -9,    -9,    -9,    -9,    -9,   -23,
     -23,   -23,     6,     6,   -23,   -23,    65,     6,   -23,   -23
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,     0,    22,     0,    39,    41,    42,     0,     0,     0,
       0,     0,     0,     0,    51,    47,    48,    49,    50,     0,
       0,    38,    40,    31,    32,    33,    34,    36,    35,    29,
      23,    52,     0,     0,    30,    24,    27,     0,    25,    26
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -23,   -23,    73,   -23,   -23,    71,    -6,   -10,   -23,    64,
...
static const yytype_int8 yytable[] =
{
      15,    37,     6,    13,    48,    49,    50,    51,    24,     1,
       2,    13,    50,    51,    47,    19,     8,    14,     9,    54,
      24,    20,    21,    22,    16,    14,   -16,    34,    65,    66,
      67,    68,    17,     1,     2,    18,    71,    73,    74,    75,
      76,    77,    78,    34,    23,     1,     2,    33,    38,    19,
      39,    53,    35,    64,    36,    20,    21,    22,    40,    14,
      41,    43,    48,    49,    50,    51,    70,    44,    35,    56,
      36,    79,    84,    85,    80,    87,     7,    89,    23,     1,
       2,    57,    58,    59,    60,    61,    62,    72,    32,    81,
      42,    52
};
...
static const yytype_uint8 yycheck[] =
{
      ...
      50,    51,     5,    31,    32,    30,    56,    57,    58,    59,
      60,    61,    62,     3,    30,    31,    32,     3,     3,     1,
      17,    27,    28,     4,    30,     7,     8,     9,    30,    11,
      12,     6,    13,    14,    15,    16,    29,     6,    28,    17,
      30,     4,    82,    83,     4,    10,     3,    87,    30,    31,
      32,    21,    22,    23,    24,    25,    26,    56,    17,    27,
      26,    38
};
...
static const yytype_uint8 yystos[] =
{
      ...
      15,    16,    51,    27,    54,    55,    17,    21,    22,    23,
      24,    25,    26,    49,     4,    54,    54,    54,    54,    44,
      29,    54,    55,    54,    54,    54,    54,    54,    54,     4,
       4,    27,    50,    45,    40,    40,    46,    10,    47,    40
};
...
#line 1524 "y.tab.c" /* yacc.c:1646  */
  ...
  case 38:
#line 241 "aghax2.y" /* yacc.c:1646  */
    {if (!strcmp((yyvsp[-3].intval), "int")){printf("%s = %s ;\n", (yyvsp[-2].symp) -> name, (yyvsp[0].intval) ); (yyvsp[-2].symp) -> type = "int";} else{yyerror("type missmatch ; int assignment to char ; expected 'int' ");} removetemp(tempnum);  }
#line 1530 "y.tab.c" /* yacc.c:1646  */
    break;

  case 39:
#line 242 "aghax2.y" /* yacc.c:1646  */
    { if( !strcmp((yyvsp[-2].symp) -> type, "int")){printf("%s = %s ;\n", (yyvsp[-2].symp) -> name, (yyvsp[0].intval) );}else{yyerror("type miss match ");} removetemp(tempnum); }
#line 1536 "y.tab.c" /* yacc.c:1646  */
    break;

  case 40:
#line 243 "aghax2.y" /* yacc.c:1646  */
    {if (!strcmp((yyvsp[-3].intval), "char")){printf("%s = %s ;\n", (yyvsp[-2].symp) -> name, (yyvsp[0].charval) );(yyvsp[-2].symp) -> type = "char";} else{yyerror("type missmatch ; char assignment to int expected 'char' ");} removetemp(tempnum);  }
#line 1542 "y.tab.c" /* yacc.c:1646  */
    break;

  case 42:
#line 245 "aghax2.y" /* yacc.c:1646  */
    {  }
#line 1548 "y.tab.c" /* yacc.c:1646  */
    break;

  case 44:
#line 250 "aghax2.y" /* yacc.c:1646  */
    {  }
#line 1554 "y.tab.c" /* yacc.c:1646  */
    break;

  case 45:
#line 255 "aghax2.y" /* yacc.c:1646  */
    { (yyval.intval) = (yyvsp[0].intval); }
#line 1560 "y.tab.c" /* yacc.c:1646  */
    break;

  case 46:
#line 256 "aghax2.y" /* yacc.c:1646  */
    { (yyval.intval) = (yyvsp[0].symp) -> name ;}
#line 1566 "y.tab.c" /* yacc.c:1646  */
    break;

  case 47:
#line 257 "aghax2.y" /* yacc.c:1646  */
    { if(istemp((yyvsp[-2].intval))){
                                     if(istemp((yyvsp[0].intval))){removetemp(1);}
                                     printf("%s = %s + %s ; \n", (yyval.intval) =  (yyvsp[-2].intval) ,(yyvsp[-2].intval) , (yyvsp[0].intval) ) ;   
